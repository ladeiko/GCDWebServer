...
Pod::Spec.new do |s|
  s.name     = 'GCDWebServerX'
  s.version  = '3.5.4.1'
  s.author   =  { 'Pierre-Olivier Latour' => 'info@pol-online.net',
                  'Siarhei Ladzeika' => 'sergey.ladeiko@gmail.com' }
  s.license  = { :type => 'BSD', :file => 'LICENSE' }
  s.homepage = 'https://github.com/ladeiko/GCDWebServer'
  s.summary  = 'Fork of GCDWebServer - Lightweight GCD based HTTP server for OS X & iOS (includes web based uploader & WebDAV server)'
  
  s.source   = { :git => 'https://github.com/ladeiko/GCDWebServer.git', :tag => s.version.to_s }
